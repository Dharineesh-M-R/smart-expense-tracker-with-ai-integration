...
export default function BudgetInsightsPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 p-6">
      <h1 className="text-3xl font-bold mb-6 text-yellow-600">📊 Budget & Insights</h1>

      {/* AI Recommendations */}
      <Card className="mb-6 border-yellow-600 shadow-md">
        <CardHeader>
          <CardTitle className="text-yellow-600">💡 AI Budget Recommendations</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid md:grid-cols-4 gap-4 mb-6">
        {categoryData.map((c, i) => (
          <Card key={i} className="border-yellow-600 hover:shadow-lg transition">
            <CardHeader className="pb-2">
              <CardTitle className="text-yellow-700">{c.name}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-xl font-bold text-yellow-600">₹{c.value}</p>
            </CardContent>
          </Card>
        ))}
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="border-yellow-600 shadow-md">
          <CardHeader>
            <CardTitle className="text-yellow-600">Category Wise Spending</CardTitle>
          </CardHeader>
        ...
        <Card className="border-yellow-600 shadow-md">
          <CardHeader>
            <CardTitle className="text-yellow-600">Weekly Expense Analysis</CardTitle>
          </CardHeader>
          <CardContent className="h-80">
            <ResponsiveContainer width="100%" height="100%">
